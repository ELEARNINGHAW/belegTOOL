...
$tabledit->table = 'mdl_haw_studiengaenge';
...
$tabledit->fields_in_list_view = array('ID', 'studiengang','abk' ,'abk2');
...
$tabledit->fields_required = array( 'ID','studiengang','abk','abk2');
